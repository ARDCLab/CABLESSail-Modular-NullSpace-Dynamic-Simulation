...
% ----------------------------------------------------------------------- %
    ...
    % Compute Upsilon_dot for the booms
    ...
    % compute Upsilon_dot for the AMT
    ups_dot_g = -C_ab*crossr(w_ba_b)*crossr(r_gb_b);
    ...
    ups_dot = [zeros(3),    zeros(3),   zeros(3,6), zeros(3,6), zeros(3,6), zeros(3,6);
               ...
               zeros(3),    ups_dot_g,   zeros(3,6), zeros(3,6), zeros(3,6), zeros(3,6);
               zeros(3),    zeros(3),   zeros(3,6), zeros(3,6), zeros(3,6), zeros(3,6)];
end
